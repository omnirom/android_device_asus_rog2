...
public class GripSensor {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            synchronized (mLock) {
                ...
                mServiceState = REMOTE_SERVICE_STATE_BOUND;
        ...
        public void onServiceDisconnected(ComponentName className) {
            synchronized (mLock) {
                ...
                mServiceState = REMOTE_SERVICE_STATE_UNBOUND;
            }
        }
    };
    ...
    public void onStart() {
        ...
        sensorServiceHandler.sendEmptyMessage(MSG_REGISTER_GRIPSENSOR);
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MSG_BIND_SERVICE:
                    ...
                    if (gripMessengerServiceState == REMOTE_SERVICE_STATE_UNBOUND) {
                        ...
                        return;
                    } else if (gripMessengerServiceState == REMOTE_SERVICE_STATE_BINDING) {
    ...
    private void doBindServiceLocked() {
        ...
        try {
            mContext.bindServiceAsUser(intent, mConnection, REMOTE_SERVICE_STATE_BINDING, UserHandle.CURRENT);
            mServiceState = REMOTE_SERVICE_STATE_BINDING;
    ...
    private void updateSensorEventToRemoteLocked(Bundle in) {
        ...
        } else if (mServiceState == REMOTE_SERVICE_STATE_UNBOUND) {
