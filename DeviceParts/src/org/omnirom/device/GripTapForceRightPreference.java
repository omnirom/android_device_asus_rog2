...
public class GripTapForceRightPreference extends Preference implements
    ...
    private static final String TAP_FORCE_RIGHT = "/proc/driver/grip_tap2_force";
    public static final String GRIP_TAPFORCE_KEY = DeviceSettings.KEY_SETTINGS_PREFIX + GripTapForce.GRIP_TAPFORCE_LEFT_RIGHT;
    public static final String DEFAULT_VALUE = "1";

    public GripTapForceRightPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public static boolean isSupported() {
        return Utils.fileWritable(TAP_FORCE_RIGHT);
    }

    public static String getValue(Context context) {
        String val = Utils.getFileValue(TAP_FORCE_RIGHT, DEFAULT_VALUE);
        return val;
    }

    private void setValue(String newValue) {
        Utils.writeValue(TAP_FORCE_RIGHT, newValue);
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(TAP_FORCE_RIGHT, storedValue);
    }
