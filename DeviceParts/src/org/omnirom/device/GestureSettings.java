...
public class GestureSettings extends PreferenceFragment implements
    ...
    public static final String GESTURE_CONTROL_PATH = "/sys/devices/platform/goodix_ts.0/gesture/zenmotion";
    ...
    public static String getGestureFile(String key) {
        switch(key) {
            case GESTURE_CONTROL_PATH:
                return "/sys/devices/platform/goodix_ts.0/gesture/zenmotion";
            case KEY_GOOGLE_APP:
