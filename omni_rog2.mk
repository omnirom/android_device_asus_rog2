...
ASUS_BUILD_ID := RKQ1.200710.002
ASUS_BUILD_NUMBER := 18.0210.2201.211-0

VENDOR_RELEASE := 11/$(ASUS_BUILD_ID)/$(ASUS_BUILD_NUMBER):user/release-keys
BUILD_FINGERPRINT := asus/WW_I001D/ASUS_I001_1:$(VENDOR_RELEASE)

# Security patch level from stock
PLATFORM_SECURITY_PATCH_OVERRIDE := 2022-01-01
